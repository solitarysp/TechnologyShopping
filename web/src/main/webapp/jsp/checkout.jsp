                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-7 col-md-12 col2-right  ">
                        ...
                        <div class="rtd">  <div class="woocommerce">
                            ...
                            <form name="checkout" method="post" class="checkout woocommerce-checkout" action="http://wpsparrow.com/wordpress/ismiler/checkout/" enctype="multipart/form-data">
                                    ...
                                    <table class="shop_table woocommerce-checkout-review-order-table">
                                        ...
                                        <tr class="cart_item">
                                            <td class="product-name">
                                                BLU VIVO 5 Smartphone&nbsp;							 <strong class="product-quantity">&times; 3</strong>													</td>
                                        ...
                                        <tr class="cart-subtotal">
                                            <th>Subtotal</th>
                                            <td><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&pound;</span>2,625.00</span></td>
                                        </tr>
                                        ...
                                        <tr class="order-total">
                                            <th>Total</th>
                                            <td><strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&pound;</span>2,625.00</span></strong> </td>
                                        </tr>
