            ...
            <form name="checkout" method="get" class="checkout woocommerce-checkout"
                ...
                <div id="order_review" class="woocommerce-checkout-review-order">
                    <table class="shop_table woocommerce-checkout-review-order-table">
                        ...
                        <tr class="cart-subtotal">
                            <th>PayMen</th>
                            <th><span class="woocommerce-Price-amount amount">


                                    <c:set var="paymen" value="${payment}"/>
                <div class="col-xs-12 col-sm-9">
                    <select id="idPaymen" name="idPaymen">
                        <c:forEach items="${paymen}" var="p">
                    ...
                    <div id="payment" class="woocommerce-checkout-payment">
                        <div class="form-row place-order">
                            <noscript>
                                ...
                                click the &lt;em&gt;Update Totals&lt;/em&gt; button before placing your order. You may
                                be charged more than the amount stated above if you fail to do so. &lt;br/&gt;&lt;input
                                type="submit" class="button alt" name="woocommerce_checkout_update_totals" value="Update
                                totals" /&gt;
                            </noscript>

                            <input type="text" hidden name="idAddress"
                                   value="${param.idAddress}">
