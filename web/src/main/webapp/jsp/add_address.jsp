    ...
    <div class="b-page">
                    ...
                    <div class="col-sm-12 clearfix">
                        ...
                        <div class="b-breadcrumbs pull-right">
                            <ul class="list-unstyled">
                                ...
                                <li class="font-additional font-weight-normal color-main text-uppercase">Checkout</li>
                            </ul>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="woocommerce-billing-fields">
                                                ...
                                                <div class="woocommerce-billing-fields__field-wrapper">
                                                    <p class="form-row form-row-first validate-required"
                                                       ...
                                                       style="width: 100%">
                                                        <label for="billing_first_name" class="">Full Name<abbr
                                                    ...
                                                    <p class="form-row form-row-wide" id="billing_company_field"
                                                       data-priority="30"><label for="billing_company" class="">Company
                                                        name</label><input type="text" class="input-text "
                                                                           ...
                                                                           value="${user.customerAddress.company}"
                                                    ...
                                                    <p class="form-row form-row-wide address-field validate-state"
                                                       id="billing_state_field"><label for="billing_state"
                                                                                       class="">District</label>
                                                        <input type="text" class="input-text" name="district"
                                                               id="billing_state"
                                                               value="${user.customerAddress.district}"
                                                               autocomplete="address-level1" placeholder=""/></p>
                                                    <p class="form-row form-row-wide address-field validate-required"
                                                       id="billing_city_field" data-priority="70">
                                                        <label for="billing_city" class="">Town / City </label><input
                                                            type="text" class="input-text " name="city"
                                                            id="billing_city"
                                                            placeholder="" value="${user.customerAddress.city}"
                                                            autocomplete="address-level2"/></p>
                                                    <p class="form-row form-row-wide address-field validate-required"
                                                       data-priority="70">
                                                        <label for="billing_address_1" class="">Address <abbr
                                                                class="required" title="required">*</abbr></label><input
                                                            type="text" class="input-text" name="AddressFull"
                                                            placeholder="Address"
                                                            value="${user.customerAddress.addressFull}"
                                                            autocomplete="billing_address_1"/></p>
                                                    ...
                                                    <p class="form-row form-row-wide address-field validate-postcode"
                                                       id="billing_postcode_field" data-priority="65">
                                                        <label for="billing_postcode" class="">Postcode /
                                                            ZIP</label><input
                                                            type="text" class="input-text " name="postcode"
                                                            id="billing_postcode" placeholder=""
                                                            value="${user.customerAddress.zipCode}"
                                                    ...
                                                    <p class="form-row form-row-first validate-required validate-phone"
                                                       id="billing_phone_field" data-priority="100">
                                                        ...
                                                        <input type="tel" class="input-text " name="phone"
                                                               ...
                                                               value="${user.customerAddress.phone}"
                                                               autocomplete="tel"/>
                                                    </p>
                                                    <p class="form-row form-row-last validate-required validate-email"
                                                       id="billing_email_field" data-priority="110">
                                                        ...
                                                        <input type="email" class="input-text " name="email"
                                                               ...
                                                               value="${user.customerAddress.email}"
                                                               autocomplete="email username"/></p></div>
                                    ...
                                    <div id="order_review" class="woocommerce-checkout-review-order">
                                        <div id="payment" class="woocommerce-checkout-payment">
                                            ...
                                            <div class="form-row place-order">
                                                <input type="button" onclick="Registration()" class="button alt"
                                                       name="woocommerce_checkout_place_order" id="place_order"
                                                       value="Place order" data-value="Place order"/>

                                                <input type="hidden" name="_wpnonce" value="944d0a21ad"/><input
                                                    type="hidden" name="_wp_http_referer"
                                                    value="/wordpress/ismiler/checkout/"/></div>
                                        </div>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            function Registration() {
                ...
                $.ajax({
                    url: "/account/addAddressCustomer?${_csrf.parameterName}=${_csrf.token}",
                    type: "post",
                    dataType: "text",
                    data: data,
                    success: function (result) {
                        if (result.trim() == 'success') {
                            swal("Thêm address thành công!.")
                                .then((value) => {
                                    window.location = "/account/listAddress";
                                });
                        } else {
                            swal("lỗi không các định.")
                                .then((value) => {
                                    window.location = "/account/listAddress";
                                });
                        }
