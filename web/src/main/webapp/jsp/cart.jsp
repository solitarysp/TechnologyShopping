                    ...
                    <div class="col-xs-12 col-sm-7 col-md-12 col2-right  ">
                        ...
                        <div class="rtd">
                            <div class="woocommerce">
                                ...
                                <form action="http://wpsparrow.com/wordpress/ismiler/cart/" method="post"
                                      class="cart-table ">
                                        ...
                                        <table class="shop_table shop_table_responsive cart table" cellspacing="0">
                                            ...
                                            <tr class="cart_item">
                                                ...
                                                <td class="product-thumbnail">
                                                    <a href="http://wpsparrow.com/wordpress/ismiler/product/blu-vivo-5-smartphone/"><img
							...
							<span class="woocommerce-Price-amount amount"><span
                                    class="woocommerce-Price-currencySymbol">&pound;</span>875.00</span>						    </span>
                                                ...
                                                <td class="product-quantity" data-title="Quantity">
                                                    ...
                                                    <div class="input-group btn-block qty-block" data-trigger="spinner">
                                                        ...
                                                        <input type="text" data-rule="quantity" step="1" min="0" max=""
                                                               name="cart[2bd2e3373dce441c6c3bfadd1daa953e][qty]"
                                                               value="3" title="Qty" class="input-text qty text"
                                                ...
                                                <td class="product-subtotal" data-title="Total">
                                                    <span class="woocommerce-Price-amount amount"><span
                                                            class="woocommerce-Price-currencySymbol">&pound;</span>2,625.00</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="6" class="actions">
                                                    ...
                                                    <input type="hidden" id="_wpnonce" name="_wpnonce"
                                                           value="dded64d263"/><input type="hidden"
                                                                                      name="_wp_http_referer"
                                                                                      value="/wordpress/ismiler/cart/"/>
                                                </td>
                                            </tr>
                                        ...
                                        <table cellspacing="0" class="shop_table shop_table_responsive">
                                            ...
                                            <tr class="order-total">
                                                ...
                                                <td data-title="Total"><strong><span
                                                        ...
                                                        class="woocommerce-Price-currencySymbol">&pound;</span>2,625.00</span></strong>
                                                </td>
                                            </tr>
