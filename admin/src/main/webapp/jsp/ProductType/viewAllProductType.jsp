...
<h3 class="header smaller lighter blue">Product Types</h3>
...
<div style="float: right;" class="col-xs-6">
    <div style="margin-top: 10px;float:right;">
        ...
        <form action="/admin/getAllProductType">
...
<table id="dynamic-table" class="table table-striped table-bordered table-hover">
    ...
    <c:forEach items="${listProductTypes}" var="pt">
        <tr>
            <td class="center">
                <label class="pos-rel">
                    <input type="checkbox" class="ace"/>
            ...
            <td class="hidden-480">${pt.description}</td>

            <td>
                <div class="hidden-sm hidden-xs action-buttons">
                    <a class="blue" href="/admin/findProductTypeByID?id=${pt.id}">
                    ...
                    <a class="red" onclick="removeProductType('${pt.id}',this)" href="#">
...
<script type="application/javascript">
    function removeProductType(id, row) {
        var data = {'id': id};
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        url: "removeProductType?${_csrf.parameterName}=${_csrf.token}",
                        type: "post",
                        dataType: "text",
                        data: data,
