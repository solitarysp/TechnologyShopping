...
<div class="col-xs-12">
    ...
    <form class="form-horizontal" id="form" method="post" role="form">
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input readonly type="text" id="id" name="id" placeholder="name" value="${product.id}" class="col-xs-10 col-sm-5"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="name" name="name" value="${product.name}" placeholder="name" class="col-xs-10 col-sm-5"/>
            </div>
        </div>
        ...
        <div class="col-md-offset-3 col-md-9">
            <button onclick="updateProduct()" class="btn btn-info" type="button">
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.trim() == 'success') {
                    ...
                    window.location.replace("/admin/getAllProduct");
                }
            },
