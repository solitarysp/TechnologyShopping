...
CREATE TABLE order_product(
  _id INTEGER PRIMARY KEY auto_increment,
  _date DATETIME DEFAULT current_timestamp,
  _status_payment NVARCHAR(100) DEFAULT N'Chưa thanh toán' NOT NULL,
  _status_delivery NVARCHAR(100) DEFAULT N'Chưa vận chuyển' NOT NULL,
  ...
  _status_bill NVARCHAR(100) DEFAULT N'Hiện tại'
);
...
INSERT administrator (`_email`, `_user`,`_password`) VALUES ('solitarysp@gmail.com','solitarysp','chicanem');

INSERT customer (`_email`, `_user`, `_password`, `_name`) VALUES ('email','user','123','thanh');

SELECT *
FROM product AS p WHERE _type=1
